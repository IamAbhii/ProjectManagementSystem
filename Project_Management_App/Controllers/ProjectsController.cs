...
namespace Project_Management_App.Controllers
{
    ...
    public class ProjectsController : Controller
    {
        ...
        private NotificationManagement notificationManager;
        ...
        public ActionResult Create([Bind(Include = "ProjectId,ProjectName,Startdate,DeadLine,CompletePercentage")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProjectId,ProjectName,Startdate,DeadLine,CompletePercentage")] Project project)
        {
            if (ModelState.IsValid)
            {
